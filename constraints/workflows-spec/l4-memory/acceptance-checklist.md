...
- [ ] `MUST` TradeCase.vNext 字段已定义：`thinking_chain[]`、`evidence_chain[]`、`decision_outcome`。
...
- [ ] `MUST` `review_engine/a7_a8_adapter/thinking_chain_index_extension` 与规范字段对齐。
